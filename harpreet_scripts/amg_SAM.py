...
#Description:
## This python file is a modified script amg.py (Segmentanything-MetaAI). The image contains a colorcard which accounts for a large number of masks.
# The top portion of the image having color card has been removed using .crop from skutils(Sklearn).
# This file should be used for creating the masks and saving them to an output folder, using cuda/gpu. 
# Additionally, masks can be generated for images from the command line:
# python amg_SAM.py --checkpoint sam_vit_h_4b8939.pth --model-type vit_h --input <image_or_folder> --output <path/to/output> --device cuda
